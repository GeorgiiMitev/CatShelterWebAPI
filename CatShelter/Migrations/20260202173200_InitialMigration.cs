    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatVaccines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CatVaccines_Cats_CatId",
                        column: x => x.CatId,
                        principalTable: "Cats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatVaccines_Vaccines_VaccineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteCats_Cats_CatId",
                        column: x => x.CatId,
                        principalTable: "Cats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteCats_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatVaccines_CatId",
                table: "CatVaccines",
                column: "CatId");

            migrationBuilder.CreateIndex(
                name: "IX_CatVaccines_VaccineId",
                table: "CatVaccines",
                column: "VaccineId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCats_CatId",
                table: "FavoriteCats",
                column: "CatId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCats_UserId",
                table: "FavoriteCats",
                column: "UserId");
        }
